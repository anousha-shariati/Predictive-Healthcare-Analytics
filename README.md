...
1. Data Loading: Loaded structured hospital data (CHARTEVENTS, LABEVENTS, ADMISSIONS) and unstructured clinical notes (NOTEEVENTS) from CSV files.

2. Structured Data Preprocessing: Filled missing values, normalized numeric features, and aggregated measurements per hospital admission.

3. Unstructured Data Pipeline: Prepared clinical notes by cleaning, lowercasing, tokenizing, and tagging for future Doc2Vec embeddings. 

4. Feature Fusion: Combined structured features with unstructured embeddings to create a multimodal feature matrix.
